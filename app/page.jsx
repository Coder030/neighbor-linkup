      ...
      <div className="bg-[#191919] pb-[0px] h-fit">
        ...
        <div className="mx-[5%] flex flex-col gap-4 py-7">
          <div className="flex flex-col lg:flex-row lg:justify-between">
           ...
           {/* my changes */}
          <div className="text-[#fff] flex items-center gap-6">

          <div className="relative bg-[#26262647] p-4 rounded-md max-w-[44rem] ">
            <div className="absolute top-[-3.1rem] left-0 bg-[#346E5C] p-3 px-4 rounded-t-lg border-[1px] border-[#7FC8B2]">EVENT</div>

              <div className="flex items-center">
                <img src="/event-img.svg" alt="event image" />
                <div>
                  <div className="text-[18px] mb-4 font-bold">Gay pride day meet up</div>
                  <div className="flex items-center gap-8">
                    <div className="flex items-center gap-2 text-sm p-3 px-5 rounded-lg bg-[#26262699]">
                    <svg width="13" height="18" viewBox="0 0 13 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p>Kim Song Un Stadium, Pyeong....</p>
                    </div>
                    <div className="flex items-center gap-2 text-sm p-3 px-5 rounded-lg bg-[#26262699]">
              ...
              <p className="text-[15px] text-[#6D6C6C] pl-5 max-w-[35rem] mb-6">
              Meet UI UX designers and graphic designers from all across the globe. We are certainly that it is going to be a great learning experience for you....
              </p>

              <div className="border-t-[1px] border-[#6D6C6C] px-5 pt-6 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <p className="text-[15px] text-[#6D6C6C]">Posted by:</p>

                  <div className="flex items-center gap-3 border-[1px] border-[#6D6C6C] p-2 rounded-full px-3">
                    <img src="/author-avatar.svg" alt="author avatar" />
                ...
                <div className="flex items-center gap-4">
                  <div>
                    <img src="/user-img.svg" alt="user image" />
                  </div>

                  <div className="p-2 px-4 border-[1px] border-[#6D6C6C] rounded-3xl">
                    + 10
                  </div>

                  <div className="p-4 py-3 rounded-lg bg-[#2D2D2D80]">
                    <svg
                    width="21"
                    height="21"
                    viewBox="0 0 21 21"
          ...
          <div className="relative bg-[#26262647] p-4 rounded-md max-w-[44rem] ">
            <div className="absolute top-[-3.1rem] left-0 bg-[#954B4B] p-3 px-4 rounded-t-lg border-[1px] border-[#F48989]">EVENT</div>
